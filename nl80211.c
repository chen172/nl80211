				   ...
				   int flags, u8 cmd)
{
	...
	//define in linux kernel net/genetlink.c
			      ...
			      int flags, struct nl80211_dump_wiphy_state *state)
{
	...
	//put genl message header to msg, return genl message header pointer
	...
	//NL80211_ATTR_WIPHY is attribute
	//rdev->wiphy_idx is attribute value
	//define in linux kernle include/net/netlink.h
	//and the nla_put define in linux kernel lib/attr.c
				    ...
				    struct nl80211_dump_wiphy_state *state)
{
	...
	printk("nl80211_dump_wiphy_parse11111111111111111111111\n");
...
static int nl80211_dump_wiphy(struct sk_buff *skb, struct netlink_callback *cb)
{
	...
	if (!state) {
		...
		printk("nl80211_dump_wiphy00000000000000000000\n");
